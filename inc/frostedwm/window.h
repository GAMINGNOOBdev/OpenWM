...
#define COLOR_BORDER_BAR FROSTEDWM_COLOR_RGBA(0x35,0x35,0x35,0xFF)

#define COLOR_TITLE_BAR_1 FROSTEDWM_COLOR_RGBA(0x30,0x30,0x30,0xFF)
#define COLOR_TITLE_BAR_2 FROSTEDWM_COLOR_RGBA(0x22,0x22,0x22,0xFF)
